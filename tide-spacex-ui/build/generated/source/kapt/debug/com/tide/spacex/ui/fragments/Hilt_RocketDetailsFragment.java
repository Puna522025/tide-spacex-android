...
public abstract class Hilt_RocketDetailsFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RocketDetailsFragment_GeneratedInjector) this.generatedComponent()).injectRocketDetailsFragment(UnsafeCasts.<RocketDetailsFragment>unsafeCast(this));
    }
  }
