...
public abstract class Hilt_RocketListFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RocketListFragment_GeneratedInjector) this.generatedComponent()).injectRocketListFragment(UnsafeCasts.<RocketListFragment>unsafeCast(this));
    }
  }
